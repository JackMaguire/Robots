...
def get_mem_usage():
    ...
    return [ process.memory_info().rss/1e6, process.memory_info().vms/1e6 ]

def debug_create_model( simulate = False, use_gc = False, Kclear = False ):
...
def debug_score_simulation( use_gc = False ):

    '''
    No significant leak here
    '''
...
debug_create_model( simulate=False, use_gc=False, Kclear=True )
debug_create_model( simulate=False, use_gc=False, Kclear=False )
#debug_score_simulation( use_gc=False )
#debug_score_simulation( use_gc=True )
