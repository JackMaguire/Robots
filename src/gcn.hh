...
struct GCNFormulation {

  static constexpr int Q_key = 113;  //
  static constexpr int W_key = 119; //capitol is 87
  static constexpr int E_key = 101; //
  static constexpr int A_key = 97;  //65
  static constexpr int S_key = 115; //83
  static constexpr int D_key = 100; //68
  static constexpr int Z_key = 122;
  static constexpr int X_key = 120;
  static constexpr int C_key = 99;

  static constexpr int T_key = 116;
  static constexpr int SPACEBAR = 32;

  static constexpr int R_key = 114; //

  static constexpr int delete_key = 127; //
  ...
  static constexpr int Fx = ( ROUND == 1 ? 3 : 4 );
  static constexpr int S = 5;
  static constexpr int O = ( ROUND == 1 ? 9 : 10 );
  ...
  calcFx_round2(
    ...
    static constexpr float CARDINAL = 1.0;
    static constexpr float DIAGONAL = -1.0;
  ...
  has_edge(
    ...
    static constexpr double distance_cutoff = 7.5;
